...
import { Canvas as NativeCanvas, GlobalFonts, Image as NativeImage, Path2D, type AvifConfig, type SKRSContext2D as NativeCanvasRenderingContext2D } from '@napi-rs/canvas';
...
export { Path2D, GlobalFonts, NativeImage as Image };
export declare const resolveImage: typeof loadImage;
export declare function loadImage(data: Buffer): NativeImage;
